...
- Explorar outros modelos de interação espaço-temporal;
- Verificar a inclusão de outras covariáveis;
- Realizar análise de resíduos para complementar decisão por DIC.
