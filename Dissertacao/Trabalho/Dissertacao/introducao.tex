...
de trabalho acadêmico (teses e dissertações) produzido inicialmente conforme a \textbf{Informação 
CCPG/001/2015} (que trata das \emph{Normas para impressão de teses/dissertações} da 
UNICAMP). Posteriormente, foi adequada considerando a Instrução Normativa  CCPG/06/2025 \cite{CCPG:006:2025}. Encorajamos o leitor a consultar estas instruções
